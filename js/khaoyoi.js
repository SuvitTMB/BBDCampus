...
function WaitingPage() {
  ...
  .get().then((snapshot)=> {
    ...
    //alert(xEmpType);
    str +='<div class="title_container"><div class="title-head">Registration System</div></div>';
...
function showATK() {
  var str = "";
  str +='<div class="title_container"><div class="title-head">Registration System';
...
function showMeeting() {
  var str = "";
  str +='<div class="title_container"><div class="title-head">Registration System';
  str +='<div style="font-size:13px;color:#f68b1f;">กำหนดการประชุม</div></div></div>';
  str +='<div class="profile-txt" style="margin-top:-25px;font-size:12px;">'+ sessionStorage.getItem("CampName") +'</div>';
  str +='<div><img src="./img/khaoyoi-doc.jpg" style="width:370px;"></div>';
