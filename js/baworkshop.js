...
async function main() {
  await liff.init({ liffId: "1655966947-bkNOPxAE" });
...
function WaitingPage() {
  ...
  .get().then((snapshot)=> {
    ...
    //alert(xEmpType);
    str +='<div class="title_container"><div class="title-head">ยินดีต้อนรับสู่<br>BA Workshop</div></div>';
    ...
    if(xEmpType!="") {
      str +='<div class="profile-txt1" style="line-height: 1.2;color:#0056ff;">ยินดีต้อนรับสู่<br>BA Workshop<br><font color="#0056ff">'+xEmpType+'</font></div>';
    } else {
      str +='<div class="profile-txt1" style="line-height: 1.2;">ได้ลงทะเบียนเข้าร่วมงาน<br>BA Workshop<br><font color="#0056ff">'+sCampName+'</font></div>';
    }
    if(sDateTime!="") {
...
function showATK() {
  var str = "";
  str +='<div class="title_container"><div class="title-head">BA Workshop';
