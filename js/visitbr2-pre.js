...
async function main() {
  await liff.init({ liffId: "1656865573-ryRqqdwZ" });
...
function WaitingPage() {
  ...
  .get().then((snapshot)=> {
    ...
    //} else {
      str +='<div class="profile-txt1" style="line-height: 1.2;color:#ff0000;">ได้ลงทะเบียนล่วงหน้าเพื่อเข้าร่วมงาน<br><font color="#0056ff">'+sCampName+'</font> เรียบร้อยแล้ว<br>กรุณาลงทะเบียนหน้างานอีกครั้ง</div>';
    //}
