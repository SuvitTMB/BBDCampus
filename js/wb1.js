...
async function main() {
  await liff.init({ liffId: "1655966947-KPkJLNnd" });
...
function WaitingPage() {
  ...
  .get().then((snapshot)=> {
    ...
    str +='<div class="title_container"><div class="title-head">ยืนยันการลงทะเบียนเข้าร่วมงาน</div><div style="padding-top:0px;color:#f68b1f;font-weight: 600;font-size:13px;">'+sCheckOpen+'</div></div>';
...
function showATK() {
  var str = "";
  str +='<div class="title_container"><div class="title-head">แสดงผล ATK สำหรับเข้าร่วมงาน</div></div>';
  str +='<div class="profile-txt" style="margin-top:-25px;font-size:12px;">'+ sCheckOpen +'</div>';
...
function showRegister() {
  var str = "";
  var sCountID = 0;
  str +='<div class="title_container"><div class="title-head">ข้อมูลผู้ลงทะเบียนเข้าร่วมงาน<br>'+sCheckOpen+'</div></div>';
