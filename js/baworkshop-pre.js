...
async function main() {
  await liff.init({ liffId: "1655966947-kVWD0A1n" });
...
function WaitingPage() {
  ...
  .get().then((snapshot)=> {
    ...
    //} else {
      str +='<div class="profile-txt1" style="line-height: 1.2;color:#ff0000;">ได้ลงทะเบียนล่วงหน้าเพื่อเข้าร่วมงาน<br>BA Workshop<br><font color="#0056ff">'+sCampName+'</font></div>';
    //}
