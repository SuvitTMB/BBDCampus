...
async function main() {
  await liff.init({ liffId: "1656865573-zZVBBMrG" });
...
function WaitingPage() {
  ...
  .get().then((snapshot)=> {
    ...
    //} else {
      str +='<div class="profile-txt1" style="line-height: 1.2;color:#ff0000;">ได้ลงทะเบียนล่วงหน้าเพื่อเข้าร่วมงานใน<br>หลักสูตร BBD Specialist Bootcamp<br><font color="#0056ff">รุ่น '+sEmpType+'</font></div>';
    //}
    ...
    str +='<div class="btn-t1" onclick="showRegister()" style="margin-top:10px;width:280px;">ตรวจสอบรายชื่อ<br>ผู้ลงทะเบียนล่วงหน้า</div>';
...
/*
      if(doc.data().StatusRegister==0) {
        ...
        str += '<div class="txt-member" style="padding-top: 15px;">'+doc.data().LineName+'</div>';
      } else {
