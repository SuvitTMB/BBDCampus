...
async function main() {
  await liff.init({ liffId: "1655966947-OZ8oYxgJ" });
...
function CheckData() {
  ...
  .get().then((snapshot)=> {
    snapshot.forEach(doc=> {
      ...
      //alert("line 234 = "+essionStorage.getItem("LineID"));
      WaitingPage();
    });
...
function CheckMember() {
  ...
  .get().then((snapshot)=> {
    ...
    //alert("Line:291) = "+sessionStorage.getItem("EmpID"));
    //alert("Line:291) = "+sessionStorage.getItem("EmpMember"));
    //alert("Line:292) = "+sessionStorage.getItem("EmpSize"));
...
function WaitingPage() {
  ...
  .get().then((snapshot)=> {
    ...
    //alert(xEmpType);
    str +='<div class="title_container"><div class="title-head">ยินดีต้อนรับสู่<br>RASC Sales Support Workshow</div></div>';
    ...
    if(xEmpType!="") {
      str +='<div class="profile-txt1" style="line-height: 1.2;color:#0056ff;">ยินดีต้อนรับสู่<br>RASC Sales Support Workshow<br><font color="#0056ff">'+xEmpType+'</font></div>';
    } else {
      str +='<div class="profile-txt1" style="line-height: 1.2;">ได้ลงทะเบียนเข้าร่วมงาน<br>RASC Sales Support Workshow<br><font color="#0056ff">'+sCampName+'</font></div>';
    }
    if(sDateTime!="") {
...
function showATK() {
  var str = "";
  str +='<div class="title_container"><div class="title-head">RASC Sales Support Workshow';
...
function showRegister() {
  var str = "";
  var sCountID = 0;
  str +='<div class="title_container"><div class="title-head">ข้อมูลผู้ลงทะเบียนเข้าร่วมงาน<br>'+sCampName+'</div></div>';
...
function SaveData() {
  ...
  if(EidBootRegister=="") {
    ...
    //alert("EmpMember="+sessionStorage.getItem("EmpMember"));
    //alert("EmpSize="+sessionStorage.getItem("EmpSize"));
