...
function WaitingPage() {
  ...
  .get().then((snapshot)=> {
    ...
    str +='<div class="title_container"><div class="title-head">ยืนยันการลงทะเบียนเข้าร่วมงาน<br>'+sEmpType+'</div><div style="padding-top:0px;color:#f68b1f;font-weight: 600;font-size:13px;">'+sCheckOpen+'</div></div>';
...
function showATK() {
  var str = "";
  str +='<div class="title_container"><div class="title-head">แสดงผล ATK สำหรับเข้าร่วมงาน<br>'+sEmpType+'</div></div>';
